...
{
    public class IGMPEditor : PacketEditor
    {
        // layer of operation
        ...
        */
        ...
        public override Packet guiEdit(Packet packet)
        {
            if (!(packet is IGMPPacket))
            {
                throw new EditorInvalidPacket("Not a valid IGMP Packet!");
            }

            IGMPEditorForm form = new IGMPEditorForm(this,
